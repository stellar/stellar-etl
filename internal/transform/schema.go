...
type Details struct {
	...
	SetFlags           []int32    `json:"set_flags,omitempty"`
	SetFlagsString     []string   `json:"set_flags_s,omitempty"`
	...
	SourceMax          float64    `json:"source_max,omitempty"`
	SponsoredID        string     `json:"sponsored_id,omitempty"`
	...
	Value              string     `json:"value,omitempty"` // base64 encoding of bytes for operations that manage data
	ClearFlags         []int32    `json:"clear_flags,omitempty"`
	ClearFlagsString   []string   `json:"clear_flags_s,omitempty"`
	DestinationMin     string     `json:"destination_min,omitempty"`
	BumpTo             string     `json:"bump_to,omitempty"`
}
