	...
	transformedOperations = []OperationOutput{
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"asset_contract_id": "CA374MGQ6KEYR55VBTK6LDM76PQA5QJQWFOAF4EBBNF7M77YZP5FAHJN",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"asset_contract_id": "CB2HF7THKN3V25XQ23URFTQYZTN5ZKZTCY4CEQDVPFFSWREE4DX7C2FI",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
			OperationTraceCode:  "PaymentResultCodePaymentSuccess",
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"source_asset_contract_id": "CB2HF7THKN3V25XQ23URFTQYZTN5ZKZTCY4CEQDVPFFSWREE4DX7C2FI",
				"asset_contract_id":        "CB2HF7THKN3V25XQ23URFTQYZTN5ZKZTCY4CEQDVPFFSWREE4DX7C2FI",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"selling_asset_contract_id": "CA374MGQ6KEYR55VBTK6LDM76PQA5QJQWFOAF4EBBNF7M77YZP5FAHJN",
				"buying_asset_contract_id":  "CB2HF7THKN3V25XQ23URFTQYZTN5ZKZTCY4CEQDVPFFSWREE4DX7C2FI",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"selling_asset_contract_id": "CB2HF7THKN3V25XQ23URFTQYZTN5ZKZTCY4CEQDVPFFSWREE4DX7C2FI",
				"buying_asset_contract_id":  "CA374MGQ6KEYR55VBTK6LDM76PQA5QJQWFOAF4EBBNF7M77YZP5FAHJN",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
			OperationTraceCode:  "ManageSellOfferResultCodeManageSellOfferSuccess",
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"asset_contract_id": "CCNSWASPU6GUUH2EGMJLT7TQ7MKG2OTWA5JG5SBSLH2P4BNYOISABXCD",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"asset_contract_id": "CAVKFBJY7OADSTGOHTXE5BPQXCTWMSGETZQF5ZMP7ULWAY2KWPXPYCGF",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
		...
		},
		{
			...
			OperationDetails: map[string]interface{}{
				...
				"reserve_a_asset_contract_id": "CB2HF7THKN3V25XQ23URFTQYZTN5ZKZTCY4CEQDVPFFSWREE4DX7C2FI",
				"reserve_b_asset_contract_id": "CCNSWASPU6GUUH2EGMJLT7TQ7MKG2OTWA5JG5SBSLH2P4BNYOISABXCD",
			},
			ClosedAt:            hardCodedLedgerClose,
			OperationResultCode: "OperationResultCodeOpInner",
