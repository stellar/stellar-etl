...
func TestOperationEffects(t *testing.T) {
	...
	LedgerClosedAtV0, err := utils.GetCloseTimeV(harCodedCloseMetaInput, false)
	LedgerClosedAtV1, err := utils.GetCloseTimeV(harCodedCloseMetaInput, false)
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			operation := transactionOperationWrapper{
				...
				LedgerClosedAtV0: LedgerClosedAtV0,
				LedgerClosedAtV1: LedgerClosedAtV1,
			}
