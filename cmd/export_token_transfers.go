...
func processTokenTransfers(lcm xdr.LedgerCloseMeta, env utils.EnvironmentDetails, outFile *os.File, _ bool, extra map[string]string) ([]transform.SchemaParquet, int, int) {
