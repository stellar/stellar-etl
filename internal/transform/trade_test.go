...
func makeTradeTestOutput() [][]TradeOutput {
	...
	lPOneOutput := TradeOutput{
		...
		PriceD:                 123,
		BuyingOfferID:          null.IntFrom(4611686018427388005),
		SellingLiquidityPoolID: null.StringFrom("LACAKBQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAGOE"),
	...
	lPTwoOutput := TradeOutput{
		...
		PriceD:                 1,
		BuyingOfferID:          null.IntFrom(4611686018427388005),
		SellingLiquidityPoolID: null.StringFrom("LAAQEAYEAUDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABUTF"),
		LiquidityPoolFee:       null.IntFrom(30),
		HistoryOperationID:     101,
		TradeType:              2,
