...
// lucas zanotelli 2022-10-31
// this is copied from the verify package "github.com/stellar/go/services/services/horizon/internal/ingest/verify/main.go"
...
//	verifies if ledger entries provided by Add method are the same
//
...
// It's user responsibility to callStateVerifier `stateReader.Close()` when reading is done.
