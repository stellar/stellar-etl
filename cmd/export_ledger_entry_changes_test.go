...
func TestExportChanges(t *testing.T) {
	...
	tests := []CliTest{
		...
		},
		{
			...
			Args:              []string{"export_ledger_entry_changes", "-x", coreExecutablePath, "-c", coreConfigPath, "-s", "50603521", "-e", "327190", "-o", GotTestDir(t, "restored_key/"), "--export-restored-keys", "true"},
