...
func (cso ConfigSettingOutput) ToParquet() interface{} {
	...
	return ConfigSettingOutputParquet{
		...
		FrozenLedgerKeys:                       cso.FrozenLedgerKeys,
		FrozenLedgerKeysDelta:                  cso.FrozenLedgerKeysDelta,
		FreezeBypassTxs:                        cso.FreezeBypassTxs,
		FreezeBypassTxsDelta:                   cso.FreezeBypassTxsDelta,
